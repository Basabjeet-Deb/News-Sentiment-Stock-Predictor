...
STOCK_TICKERS = [
    ...
    'ADSK', 'ANSS', 'CDNS', 'SNPS', 'UBER', 'LYFT', 'ABNB', 'DASH', 'SPOT', 'RBLX',
    ...
    'DVN', 'FANG', 'HES', 'MRO', 'APA', 'OKE', 'WMB', 'KMI', 'EPD', 'ET',
    ...
    # Consumer Goods
    'PG', 'KO', 'PEP', 'PM', 'MO', 'CL', 'EL', 'KMB', 'GIS', 'K', 'HSY', 'MDLZ',
    ...
    # Media & Entertainment
    'DIS', 'PARA', 'WBD', 'FOXA', 'FOX', 'NWSA', 'NWS', 'LYV', 'MSG', 'MSGS',
